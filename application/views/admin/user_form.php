			...
			<div class="col-md-12">
				<div class="portlet box <?php echo BOX;?>">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-user"></i><?php echo ($user_id > 0 ? 'Edit' : 'New');?> User
						</div>
						<div class="actions">
							<a href="<?php echo base_url('admin/user/user_manage/1.tpd');?>" class="btn default green-stripe">
					...
					<div class="portlet-body form">
						<form action="<?php echo base_url('admin/user/user_submit.tpd');?>" method="post" id="form_sample_icon" class="form-horizontal" autocomplete="off">
							...
							<div class="form-body">
									...
									* </span>
									...
									<div class="col-md-4">
										<div class="input-icon right">
											<i class="fa"></i>
											<input type="text" class="form-control" name="user_name" value="<?php echo ($user_id > 0 ? $row->user_name : '');?>"/>
										</div>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="control-label col-md-3">Is Admin
									</label>
									<div class="col-md-4" style="margin-top:8px;">
										<label><input type="checkbox" name="user_isadmin" class="icheck" value="1" <?php echo ($user_id > 0 ? ($row->user_isadmin == 1 ? 'checked="checked"' : '') : '');?>> Is Admin </label><label>
									</div>
								</div>
								<?php
								if($user_id > 0){
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="<?php echo base_url('admin/user/user_manage/1.tpd');?>" class="btn red-sunglo">Back</a>
									</div>
								</div>
							</div>
						</form>
