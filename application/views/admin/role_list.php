			...
			<div class="col-md-12">
				...
				<div class="portlet">
					<div class="portlet-title">
						...
						<div class="actions">
							<a href="<?php echo base_url('admin/role/role_manage/0.tpd');?>" class="btn default yellow-stripe">
					...
					<div class="portlet-body">
						<div class="table-container">
							...
							<tr role="row" class="filter bg-grey-steel">
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="filter_role_name">
								</td>
								<td>
									<input type="text" class="form-control form-filter input-sm" name="filter_role_desc">
								</td>
								<td>
	...
	$(document).ready(function(){
		...
		var handleRecords = function () {
			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('admin/role/role_list');?>", // ajax source
					},
		...
		$('.btn-bootbox').live('click', function(){
			...
			bootbox.confirm("Are you sure?", function(result) {
				if(result == true){
					window.location.assign('<?php echo base_url('admin/role/role_delete');?>/' + id + '.tpd');
				}
			});
		});
