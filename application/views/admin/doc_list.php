			...
			<div class="col-md-12">
				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-list"></i>Master Document
						</div>
						<div class="actions">
							<a href="<?php echo base_url('admin/document/doc_manage')?>/0.tpd" class="btn default yellow-stripe">
					...
					<div class="portlet-body">
                        <div class="table-container">
							...
							<tr role="row" class="filter bg-grey-steel">
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="filter_docname">
								</td>
								<td></td>
                                <td>
		...
		var handleRecords = function () {
			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('admin/document/doc_list/');?>"
					},
					"order": [
						[1, "asc"]
