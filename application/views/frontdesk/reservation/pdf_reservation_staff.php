...
<table width="100%">
    <tr>
        <td style="vertical-align:top; text-align:center;" colspan="3"><h1><strong>STAFF REGISTRATION FORM</strong></h1></td>
    </tr>
    <tr>
        <td colspan="3">
...
<div id="container">
    ...
    <table width="100%" class="table_family">
        <thead>
        <tr>
            <th colspan="4" class="border-top border-right v-middle" ><h2>DOMESTIC STAFF(S)</h2></th>
        </tr>
        </thead>
        <tbody>
        ...
        <tr>
            ...
            <td class="" colspan="2" >
                <?php echo ($family['is_live_in'] > 0 ? 'Live-In Staff' : 'Live-Out Staff') ; ?>
            </td>
        </tr>
        <?php
                $i++;
