        ...
        <div class="row" style="margin-top: 0px;padding-top: 0px;">
            ...
            <div class="col-md-2 col-xs-2">
                <ul class="list-unstyled">
                    ...
                    ?>
                        <li>
                            <button type="button" class="btn red-intense pull-right <?php echo (isset($pending_amount_other) ? ($pending_amount_other > 0 ? ' hide ' : ' btn-lg ') : ' btn-lg ') ?>" style="margin-top:10px;" name="btnCheckout" id="btn-checkout"  is-frontdesk="<?php echo ($row->is_frontdesk); ?>">Check Out <i class="fa fa-check"></i></button>
                        </li>
                    <?php
                    }
                    ?>
                    <li>
                        <button type="button" class="btn green pull-right <?php echo (isset($pending_amount_other) ? ($pending_amount_other <= 0 ? ' hide ' : ' btn-lg ') : ' btn-lg ') ?>" style="margin-top:10px;" name="btnReceipt" id="btn-receipt"  pay-amount="<?php echo (isset($pending_amount_other) ? $pending_amount_other : 0) ?>" is-frontdesk="<?php echo ($row->is_frontdesk); ?>">Pay <i class="fa fa-slack"></i> <?php echo format_num($pending_amount_other,0); ?></button>
                    </li>
                    <li>
                        ...
                        <div class="btn-group pull-right" style="padding-top: 10px;">
                            ...
                            <ul class="dropdown-menu pull-right" role="menu">
                                ...
                                <li>
                                    ...
                                    <?php if($pending_amount_other <= 0 && $undeposit_amount <= 0){ ?>
                                        <li>
                                            <a href="javascript:;" class="inverse btn-change-guest text-right" style="margin-top:10px;" id="change_guest">Change Guest <i class="fa fa-exchange"></i></a>
                                        </li>
                                    <?php }?>
                                <?php } ?>
                                <li>
                                                        ...
                                                        <div class="col-md-12" style="padding-bottom: 50px;">
                                                            ...
                                                            <table class="table table-striped table-hover table-bordered table-po-detail" id="table_room" name="table_room" style="padding-top: 0px;margin-top: 0px;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th>Type</th>
                                                                    <th class="text-center" width="60px">From</th>
                                                                    <th class="text-center" width="60px">To</th>
                                                                ...
                                                                $totalRoomBilled = 0;
                                                                $totalRoomAmount = 0;
                                                                $rooms = $this->db->query('SELECT cs_corporate_bill.*, ms_unit.unit_code, ms_unit_type.unittype_desc FROM cs_corporate_bill
                                                                        JOIN ms_unit ON ms_unit.unit_id = cs_corporate_bill.unit_id
                                                                        JOIN ms_unit_type ON ms_unit_type.unittype_id = ms_unit.unittype_id
                                                                        WHERE reservation_id = ' . $reservation_id . ' AND is_othercharge <= 0 ORDER BY unit_id, bill_startdate');
                                                                ...
                                                                foreach($rooms->result_array() as $room){
                                                                    ...
                                                                    echo  '</tr>';
                                                                    if($room['is_billed'] > 0){
                                                                        $totalRoomBilled += $room['total_amount'];
                                                                    }
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-md-11">
                                                            ...
                                                            <table class="table table-striped table-hover table-bordered table-po-detail" id="table_extra" name="table_extra" style="padding-top: 0px;margin-top: 0px;">
                                                                ...
                                                                $totalPrimary = 0;
                                                                $totalOther = 0;
                                                                    $otherCharges = $this->db->query('SELECT cs_bill_detail.*, view_pos_item.item_code, view_pos_item.item_desc, ms_unit.unit_code, cs_bill_header.journal_no, cs_bill_header.company_id, pos_master_item.masteritem_title, pos_master_item.masteritem_code , ISNULL(cs_corporate_bill.is_billed,0) as is_billed
                                                                                               FROM cs_bill_detail
                                                                                               ...
                                                                                               LEFT JOIN cs_corporate_bill ON cs_corporate_bill.billdetail_id = cs_bill_detail.billdetail_id
                                                                    ...
                                                                    if($otherCharges->num_rows() > 0){
                                                                        foreach($otherCharges->result_array() as $oc){
                                                                            ...
                                                                            <td><i class="' . ($oc['is_billed'] > 0 ? 'fa fa-check font-green' : '') . '"></i></td>
                                                                                    </tr>';
                                                                ...
                                                                if($row->reservation_type == RES_TYPE::CORPORATE){
                                                                    if($otherCharges->num_rows() > 0){
                                                                        foreach($otherCharges->result_array() as $oc){
                                                                            ...
                                                                            <td class="text-right">' . format_num($oc['amount'],0) . '</td>
                                                                            <td class="text-right">' . format_num($oc['tax'],0) . '</td>
                                                                            <td class="text-right">' . format_num($oc['amount']-$oc['disc_amount']+$oc['tax'],0) . '</td><td></td>
                                                                                    </tr>';
                                                        ...
                                                        <div id="pnl_payment_list">
                                                            <table class="table table-striped table-hover table-bordered table-po-detail" id="table_payment" name="table_payment" style="padding-top: 0px;margin-top: 0px;">
                                                                ...
                                                                if(isset($payments)){
                                                                    ...
                                                                    if($row->reservation_type == RES_TYPE::CORPORATE && $paymentMain > 0){
                                                                        echo '<tr style="background-color:#E3F2FD;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div id="pnl_payment_list">
                                                            <table class="table table-striped table-hover table-bordered table-po-detail" id="table_payment" name="table_payment" style="padding-top: 0px;margin-top: 0px;">
                                                                ...
                                                                if(isset($deposits)){
                                                                    foreach($deposits as $deposit){
                                                                        ...
                                                                        echo '<tr>
                                                                            ...
                                                                            <td class="text-left" style="vertical-align:middle;">' . $deposit['trx_desc'] . ' - ' . $deposit['tenant_fullname'] . '</td>
                                                                ...
                                                                $totalRoomAmount = $totalRoomAmount - $totalRoomBilled;
                                                                $pending_amount = $pending_amount - $totalRoomBilled;
                    ...
                    <div class="col-md-7">
                        <div class="form-group hide">
                            ...
                            <div class="radio-list" >
                                <!-- label class="radio-inline" >
                                    <input type="radio" name="debtor_type" id="debtor_type_corporate" value="1" > Corporate Bill</label -->
                                <label class="radio-inline" >
                                    <input type="radio" name="debtor_type" id="debtor_type_personal" value="0" checked> Personal Bill</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="paymenttype_id" class="select2me form-control input-medium">
                                <?php
                                $payments = $this->db->query('select * from ms_payment_type where status = '.STATUS_NEW . ' AND payment_type NOT IN(' . PAYMENT_TYPE::PAYMENT_GATEWAY . ',' . PAYMENT_TYPE::AR_TRANSFER . ') order by pos ');
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#submit-receipt').live('click', function(e){
            ...
            //for(i=0;i<inv_amounts.length;i++){
                //console.log("inv " + inv_ids[i] + " - " + inv_amounts[i]);
            //}
        ...
        $('#change_guest').live('click', function(){
        ...
        $('.btn-select-tenant').live('click', function() {
            var reservation_id = parseFloat($('input[name="reservation_id"]').val()) || 0;
            var tenant_id = parseFloat($(this).attr('data-id')) || 0;
            var tenant_name = $(this).attr('data-desc');

            $('#ajax-modal').modal('hide');

            bootbox.confirm({
                message: "Change Corporate Guest to " + tenant_name + " ?",
                buttons: {
                    cancel: {
                        label: "No",
                        className: "btn-inverse"
                ...
                callback: function(result) {
                    if(result === null){
                        ...
                        if(result){
                            $.ajax({
                                 type: "POST",
                                 url: "<?php echo base_url('frontdesk/management/xchange_corporate_guest');?>",
                                 dataType: "json",
                                 data: { reservation_id: reservation_id, tenant_id : tenant_id}
                             })
                             .done(function( msg ) {
                                 //Metronic.unblockUI();
                                 if(msg.valid == '1'){
