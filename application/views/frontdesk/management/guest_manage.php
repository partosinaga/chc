			...
			<div class="col-md-12">
				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>Guest Manage
						</div>
						<div class="actions">
...
<script>
	...
	$(document).ready(function(){
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('frontdesk/management/get_guest_manage/' . get_menu_id());?>"
					},
        ...
        $('.btn-rollback').live('click', function(){
            var reservation_id = $(this).attr('data-id');

            bootbox.prompt({
                title: "Please enter rollback reason :",
                value: "",
                buttons: {
                    cancel: {
                        label: "No",
                ...
                callback: function(result) {
                    if(result === null){
                        ...
                        toastr["warning"]("Rollback reason must be filled to proceed.", "Warning");
                    }else{
                        //console.log(result);
                        Metronic.blockUI({
                            boxed: true
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url('frontdesk/management/rollback_checkin');?>",
                            dataType: "json",
                            data: { reservation_id: reservation_id, reason:result }
                        })
                            .done(function( msg ) {
                                Metronic.unblockUI();
                                if(msg.type == '0' || msg.type == '1'){
                                    ...
                                    toastr["error"]("Rollback can not be processed, please try again later.", "Error");
                                }
                            });
                    }
                }
