				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
                            ...
                            <div class="btn-group btn-group-devided">
                                <a href="<?php echo base_url('frontdesk/reservation/folio_deposit/1.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm <?php echo($is_history ? '' : 'active'); ?>">Manage</a>
                                <a href="<?php echo base_url('frontdesk/reservation/folio_deposit/2.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm <?php echo($is_history ? 'active' : ''); ?>">History</a>
                            </div>

						</div>
						<div class="actions">
                            <?php if(!$is_history){ ?>
                            <a style="margin-left:20px;" href="javascript:;" class="btn-primary btn green-seagreen btn-circle" id="posting-button"><i class="fa fa-save"></i>&nbsp;Posting</a>
							<?php if(check_session_action(get_menu_id(), STATUS_NEW)){ ?>
							<a href="<?php echo base_url('frontdesk/management/deposit_form/0.tpd');?>" class="btn default yellow-stripe">
					...
					<div class="portlet-body table-responsive">
						<div class="table-container">
                          ...
                          <form action="<?php echo base_url('frontdesk/management/posting_deposits.tpd');?>" method="post" id="frmMain">
		...
		var handleRecords = function () {
			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('frontdesk/management/get_deposit_manage/' . get_menu_id() . '/' . ($is_history ? 1 : 0));?>" // ajax source
					}
				}
			});
