			...
			<div class="col-md-12" >
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>EXPECTED ARRIVAL
						</div>
...
<script>
	$(document).ready(function(){
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: {
					...
					"ajax": {
						"url": "<?php echo base_url('frontdesk/report/xreport_expected_arrival/'. get_menu_id());?>"
					},
        ...
        $('#print-button').on('click', function(){
            ...
            window.open('<?php echo base_url('frontdesk/report/pdf_exp_arrival')?>/' + date_from + '/' + date_until + '.tpd','_blank');
        });
	});
