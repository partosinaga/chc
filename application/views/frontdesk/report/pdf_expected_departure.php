...
<head>
    <meta charset="utf-8">
    <title>Expected Departure Report</title>
...
<table width="100%" id="report_header" >
    <tr>
        <td style="vertical-align:top; text-align:center;"><h1><strong>Expected Departure Report</strong></h1></td>
    </tr>
    <tr>
            ...
            <div>
                <table style="width:100%;" class="table_detail">
                    ...
                    <tr>
                        ...
                        <th style="width:80px;" class="text-center">DEPARTURE</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    if(isset($detail)){
                        ...
                        foreach($detail as $data){
                            echo '<tr>
                                        ...
                                        <td class="text-center" style="width:80px;">' . ($data['status'] == ORDER_STATUS::CHECKIN ? dmy_from_db($data['departure_date']) . '&nbsp;&nbsp;' : '' . dmy_from_db($data['departure_date']) . '&nbsp;*' ) .'</td>
                                  </tr>';
