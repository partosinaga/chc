			...
			<div class="col-md-12" >
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>DAILY CASH
						</div>
...
<script>
	$(document).ready(function(){
			...
			grid.init({
				...
				dataTable: {
					...
					"aoColumns": [
                        ...
                        { "sClass": "text-center td-height", "sWidth" : "10%", "bSortable" : false  },
                        { "sClass": "text-center td-height", "sWidth" : "10%", "bSortable" : false  },
                        { "sClass": "text-right td-height", "sWidth" : "12%" , "bSortable" : false }
					],
					"aaSorting": [],
					"lengthMenu": [
						[10, 20, 50, 100, 150, -1],
					...
					"ajax": {
						"url": "<?php echo base_url('frontdesk/report/xreport_daily_cash/'. get_menu_id());?>"
					},
        ...
        $('#print-button').on('click', function(){
            ...
            window.open('<?php echo base_url('frontdesk/report/pdf_daily_cash')?>/' + date_from + '/' + date_until + '.tpd','_blank');
        });
	});
