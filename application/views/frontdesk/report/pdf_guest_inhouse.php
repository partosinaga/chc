...
<table width="100%" id="report_header" >
    <tr>
        <td style="vertical-align:top; text-align:center;"><h1><strong>Inhouse Guest Report</strong></h1></td>
    </tr>
    <tr>
            ...
            <div>
                <table style="width:100%;" class="table_detail">
                    ...
                    <tr>
                        ...
                        <th style="width:150px;" class="text-left">COMPANY</th>
                        <th style="width:60px;" class="text-center">TYPE</th>
                        <th style="width:60px;" class="text-center">ROOM</th>
                        <th style="width:50px;" class="text-center">ARRIVAL</th>
                        <th style="width:50px;" class="text-center">DEPARTURE</th>
                        <th style="width:20px;" class="text-center">PAX</th>
                    ...
                    if(isset($detail)){
                        ...
                        foreach($detail as $data){
                            echo '<tr>
                                        ...
                                        <td style="width:150px;">' . $data['company_name'] .'</td>
                                        ...
                                        <td class="text-center" style="width:50px;">' . dmy_from_db($data['arrival_date']) . '</td>
                                        <td class="text-center" style="width:50px;">' . dmy_from_db($data['departure_date']) . '</td>
                                        <td class="text-center" style="width:20px;">' . format_num($data['qty_adult'] + $data['qty_child'],0) . '</td>
                                  </tr>';
