			...
			<div class="col-md-12" >
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>INHOUSE GUEST
						</div>
...
<script>
	$(document).ready(function(){
			...
			grid.init({
				...
				dataTable: {
					...
					"aoColumns": [
                        ...
                        { "sClass": "text-center td-height", "sWidth" : "7%" , "bSortable" : false },
                        { "sClass": "text-center td-height", "sWidth" : "7%" , "bSortable" : false },
                        { "sClass": "text-center td-height", "sWidth" : "3%" , "bSortable" : false }
					...
					"ajax": {
						"url": "<?php echo base_url('frontdesk/report/xreport_guest_inhouse/'. get_menu_id());?>"
					},
        ...
        $('#print-button').on('click', function(){
            ...
            window.open('<?php echo base_url('frontdesk/report/pdf_guest_inhouse')?>/' + date_from + '.tpd','_blank');
        });
	});
