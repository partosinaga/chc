			...
			<div class="col-md-12" >
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>Reservation Report
						</div>
...
<script>
	$(document).ready(function(){
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: {
					...
					"ajax": {
						"url": "<?php echo base_url('frontdesk/report/xreport_reservation/'. get_menu_id());?>"
					},
        ...
        $('#print-button').on('click', function(){
            ...
            window.open('<?php echo base_url('frontdesk/report/pdf_reservation')?>/' + date_from + '.tpd','_blank');
        });
	});
