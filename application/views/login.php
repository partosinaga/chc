...
<div class="logo">
	<a href="javascript:;">
	<img src="<?php echo base_url();?>assets/admin/layout/img/logo-big-white.png" style="" alt=""/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?php echo base_url('login/login_post.tpd');?>" method="post">
...
<div class="copyright hide">
	 <?php echo date('Y');?> © The Pakubuwono Development.
</div>
<!-- END LOGIN -->
