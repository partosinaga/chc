			...
			<div class="col-md-12">
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>Return <?php echo ($type == '0' ? 'Manage' : 'History');?>
						</div>
						<div class="actions">
							<?php if(check_session_action(get_menu_id(), STATUS_NEW)){ ?>
                                <a href="<?php echo base_url('inventory/retur/return_form/0.tpd');?>" class="btn default yellow-stripe">
                                    <i class="fa fa-plus"></i>
                                    <span class="hidden-480"> New Return </span>
                                </a>
							<?php } ?>
						</div>
					</div>
                            ...
                            <div class="col-md-12" style="padding-bottom: 80px;">
                                ...
                                <thead>
                                    <tr role="row" class="heading">
                                        ...
                                        <th class="text-center" width="90px"> Return Code </th>
                                        <th class="text-center" width="100px"> Return Date </th>
                                        <th class="text-center" width="90px"> GRN Code </th>
                                    ...
                                    <tr role="row" class="filter bg-grey-steel">
                                        ...
                                        <td>
                                            <div class="input-group date date-picker margin-bottom-5" data-date-format="dd-mm-yyyy">
                                                <input type="text" class="form-control form-filter input-sm" readonly name="filter_return_date_from" placeholder="From">
                                                <span class="input-group-btn">
                                                <button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
                                                </span>
                                            </div>
                                            <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                                <input type="text" class="form-control form-filter input-sm" readonly name="filter_return_date_to" placeholder="To">
                                                <span class="input-group-btn">
                                                <button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
                                                </span>
                                            </div>
		...
		var handleRecords = function () {
			...
			grid.init({
				...
				dataTable: {
					...
					"ajax": {
						"url": "<?php echo base_url('inventory/retur/ajax_return_list/' . get_menu_id() . '/' . $type);?>" // ajax source
					}
				}
			});
                    ...
                    callback: function(result) {
                        if(result === null){ }
                            ...
                            $.ajax({
                                ...
                                dataType: "json",
                                data: {return_id: return_id, action: action, reason:result }
                            })
                                .done(function( msg ) {
                                    Metronic.unblockUI();
                                    console.log(msg);
                ...
                bootbox.confirm("Are you sure want to " + action_code + " " + return_code + " ?", function (result) {
                    if (result == true) {
                        ...
                        $.ajax({
                            ...
                            url: "<?php echo base_url('inventory/retur/ajax_return_action');?>",
                            dataType: "json",
                            data: {return_id: return_id, action: action}
                        })
                            .done(function (msg) {
                                Metronic.unblockUI();
                                console.log(msg);
