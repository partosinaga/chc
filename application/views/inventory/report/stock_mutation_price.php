            ...
            <div class="col-md-12" >
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-users"></i>Report Stock Mutation Price
                        </div>
                    </div>
                            ...
                            <div class="col-md-12" style="padding-bottom: 20px; ">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable table-small table-po-detail" id="datatable_ajax" >
                                    ...
                                    <tr class="heading">
                                        ...
                                        <th class="text-center" width="100px"> START QTY </th>
                                        <th class="text-center" width="120px"> START AMOUNT </th>
                                        <th class="text-center" width="100px"> MUTATION QTY </th>
                                        <th class="text-center" width="120px"> MUTATION AMOUNT </th>
                                        <th class="text-center" width="100px"> END QTY </th>
                                        <th class="text-center" width="120px"> END AMOUNT </th>
                                    ...
                                    <tr role="row" class="filter bg-grey-steel">
                                        ...
                                        <td>
                                            <div class="input-group margin-bottom-5" >
                                                <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_start_amount_from" placeholder="Min">
                                            </div>
                                            <div class="input-group " >
                                                <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_start_amount_to" placeholder="Max">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group margin-bottom-5" >
                                                <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_mutation_qty_from" placeholder="Min">
                                            </div>
                                            <div class="input-group " >
                                                <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_mutation_qty_to" placeholder="Max">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group margin-bottom-5" >
                                                <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_mutation_amount_from" placeholder="Min">
                                            </div>
                                            <div class="input-group " >
                                                <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_mutation_amount_to" placeholder="Max">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group margin-bottom-5" >
                                        ...
                                        <td>
                                            <div class="input-group margin-bottom-5" >
                                                <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_end_amount_from" placeholder="Min">
                                            </div>
                                            <div class="input-group " >
                                                <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_end_amount_to" placeholder="Max">
                                            </div>
                                        </td>
                                        <td>
            ...
            grid.init({
                ...
                dataTable: {
                    ...
                    "aoColumns": [
                        ...
                        { "bSortable": false, "sClass": "text-right td-height" },   // Start Amount
                        { "bSortable": false, "sClass": "text-right td-height"  },  // Mutation Qty
                        { "bSortable": false, "sClass": "text-right td-height"  },  // Mutation Qty
                        { "bSortable": false, "sClass": "text-right td-height"  },  // End Qty
                        { "bSortable": false, "sClass": "text-right td-height"  },  // End Amount
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('inventory/report/ajax_stock_mutation_price/'. get_menu_id());?>"
                    },
