            ...
            <div class="col-md-12" >
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-users"></i>Report Stock Mutation Detail
                        </div>
                    </div>
                            ...
                            <div class="col-md-12" style="padding-bottom: 20px; ">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable table-small table-po-detail" id="datatable_ajax" >
                                    ...
                                    <tr class="heading">
                                        ...
                                        <th class="text-center" width="120px"> DOC DATE </th>
        ...
        var handleRecords = function () {
            grid.init({
                ...
                dataTable: {
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('inventory/report/ajax_stock_mutation_detail/'. get_menu_id());?>"
                    },
