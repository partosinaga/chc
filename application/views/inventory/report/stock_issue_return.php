            ...
            <div class="col-md-12" >
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-users"></i>Report Stock Issue / Return
                        </div>
                    </div>
                        ...
                        <div class="table-container table-responsive" >
                            <div class="col-md-12" style="padding-bottom: 20px; ">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable table-small table-po-detail" id="datatable_ajax" >
                                    <thead>
                                    <tr class="heading">
                                        <th class="text-center" width="100px"> DOC NO </th>
                                        <th class="text-center" width="100px"> DOC DATE </th>
                                        <th class="text-center" width="100px"> REQ CODE </th>
                                        <th class="text-center" width="120px"> ITEM CODE </th>
                                        <th class="text-center"> DESCRIPTION </th>
                                        <th class="text-center" width="100px"> UOM </th>
                                        <th class="text-center" width="120px"> QTY </th>
                                    ...
                                    <tr role="row" class="filter bg-grey-steel">
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm date-picker margin-bottom-5" data-date-format="dd-mm-yyyy" readonly name="filter_doc_date_from" placeholder="From">
                                            <input type="text" class="form-control form-filter input-sm date date-picker" readonly name="filter_doc_date_to" placeholder="To" data-date-format="dd-mm-yyyy">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="filter_req_code">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="input-group margin-bottom-5" >
                                                <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_amount_from" placeholder="Min">
                                            </div>
                                            <div class="input-group " >
        ...
        var handleRecords = function () {
            grid.init({
                ...
                dataTable: {
                    ...
                    "bStateSave": false,
                    "aoColumns": [
                        { "bSortable": true, "sClass": "text-center td-height" },   // Doc No
                        { "sClass": "text-center td-height" },                      // Doc Date
                        { "bSortable": false, "sClass": "text-center td-height" },  // Req Code
                        { "sClass": "text-center td-height" },                      // Item Code
                        ...
                        { "bSortable": false, "sClass": "text-right td-height"  },  // Amount
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('inventory/report/ajax_stock_issue_return/'. get_menu_id());?>"
                    },
