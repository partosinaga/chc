			...
			<div class="col-md-12" >
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>Report Stock Position
						</div>
					</div>
						...
						<div class="table-container table-responsive" >
                            <div class="col-md-12" style="padding-bottom: 20px; ">
                                <div class="table-actions-wrapper">
                                    <!--input type="text" class="form-control form-filter form-filter-wrapper input-sm date date-picker text-center" data-date-format="dd-mm-yyyy" readonly name="filter_date" placeholder="From"-->
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable table-small table-po-detail" id="datatable_ajax" >
                                    <thead>
                                        <tr class="heading">
                                            ...
                                            <th class="text-center" width="120px"> UOM </th>
                                            <th class="text-center" width="120px"> QTY </th>
                                            <th class="text-center" width="130px"> PRICE/UNIT </th>
                                        ...
                                        <tr role="row" class="filter bg-grey-steel">
                                            ...
                                            <td>
                                                <div class="input-group margin-bottom-5" >
                                                    <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_price_from" placeholder="Min">
                                                </div>
                                                <div class="input-group " >
                                                    <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_price_to" placeholder="Max">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group margin-bottom-5" >
                                                    <input type="text" class="form-control form-filter input-sm text-center mask_currency" name="filter_total_from" placeholder="Min">
                                                </div>
                                                <div class="input-group " >
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: {
					...
					"ajax": {
						"url": "<?php echo base_url('inventory/report/ajax_stock_position/'. get_menu_id());?>"
					},
