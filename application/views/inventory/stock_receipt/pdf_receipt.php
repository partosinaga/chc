...
<head>
    <meta charset="utf-8">
    <title><?php echo $row->sr_code;?></title>
...
<table>
    <tr><td colspan="2"><h1><strong>STOCK RECEIPT</strong></h1></td></tr>
</table>
        ...
        <td>
            <table>
                ...
                <tr>
                    <td>DATE</td>
                    <td>:</td>
                    <td><?php echo ymd_to_dmy($row->sr_date);?></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <table>
        ...
        foreach($qry_det->result() as $row_det){
            echo '<tr style="height: 30px;">
                ...
                <td class="border padding-3 text-center">' . $row_det->uom_out_code . '</td>
