			...
			<div class="col-md-12">
				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>Journal Recurring Manage
						</div>
						<div class="actions">
                            <a style="margin-left:20px;" href="javascript:;" class="btn-primary btn green-seagreen" id="posting-button"><i class="fa fa-save"></i>&nbsp;Start Task</a>
...
<script>
		...
		var handleRecords = function () {
			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('finance/recur/get_recur_manage/' . get_menu_id());?>"
					}
				}
			});
    ...
    $("#table_recur_manage #checkall").click(function () {
        if ($("#table_recur_manage #checkall").is(':checked')) {
            $("#table_recur_manage input[type=checkbox]").each(function () {
