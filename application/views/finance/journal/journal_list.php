			...
			<div class="col-md-12">
				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>Posted Journal Entries
						</div>
						<div class="actions">
					...
					<div class="portlet-body table-responsive">
						<div class="table-container">
							...
							<table class="table table-striped table-bordered table-hover dataTable" id="table_journal_list">
							<thead>
		...
		var handleRecords = function () {
			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('finance/journal/get_journal_list/' . get_menu_id());?>", // ajax source
					}
				}
			});
			
			var tableWrapper = $("#table_journal_list_wrapper");
