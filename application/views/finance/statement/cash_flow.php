<div class="page-content" style="margin-left:0px; min-height:700px;">
	...
	<div class="row hidden-print">
		<div class="col-md-12">
			...
			<h3 class="page-title text-center" style="font-size:25px;margin-bottom:5px;">CASH FLOW</h3>
...
<script>
	function open_detail(month, year, sub_ctg_name, account_name, value){
		if(value > 0){
			window.open('<?php echo base_url('finance/statement/cf_breakdown');?>/' + month + '/' + year + '/' + encode_string(sub_ctg_name) + '/' + encode_string(account_name) + '.tpd','_blank');
		}
	}
	...
	jQuery(document).ready(function(){
		$.post( "<?php echo base_url('finance/statement/ajax_cf_main/' . $month . '/' . $year);?>", function( data ) {
