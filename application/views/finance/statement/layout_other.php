                                    ...
                                    <div class="tab-pane active" id="portlet_layout_bs">
                                        ...
                                        <div class="portlet blue-madison box">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <?php echo $report_type == GLStatement::PROFIT_LOSS ? 'Income Statement' : 'Cash Flow'; ?>
                                                </div>
                                                <div class="actions">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a href="<?php echo base_url('finance/statement/layout_setting/' . GLStatement::BALANCE_SHEET) ?>">Balance Sheet</a></li>
                                            ...
                                            <div class="portlet-body ">
                                                <div class="table-container">
                                                    <form method="post" action="<?php echo base_url('finance/statement/submit_layout_by_type/' . $report_type)?>">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="text-left ">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="text-right ">
                                                                <a href="<?php echo base_url('finance/statement/layout_form/' . $report_type . '/0')?>" class="btn default grey-stripe">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover table-po-detail" id="table_layout_other">
                                                        <thead>
                                                        <tr role="row" >
                                                            <th >
                                                                CATEGORY
                                                            ...
                                                            if(count($row_det) > 0){
                                                                foreach($row_det as $row){
                                                                    ...
                                                                    echo '<td><input type="text" name="f_range_start[]" value="' . $row['rangeformula_start'] . '" class="form-control input-sm text-center"></td>
                                                                          ...
                                                                          <td style="vertical-align:top;padding-top:5px;"><a data-link="' . base_url('finance/statement/layout_delete/'. $row['detail_id'] . '/' . $report_type) . '" data-placement="top" data-container="body" class="btn btn-xs red-intense remove_detail" href="javascript:;"><i class="fa fa-remove"></i></a></td>' ;
                                                                    echo '</tr>';
                                                                }
                                                            }
                                                        ?>
...
<script>
    $(document).ready(function(){
        ...
        var initTable = function () {
            ...
            var tableWrapper = $('#table_layout_other_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
            var tableColumnToggler = $('#table_layout_other_column_toggler');
