<div class="page-content" style="margin-left:0px; min-height:700px;">
    ...
    <div class="row hidden-print">
        <div class="col-md-12">
            ...
            <h3 class="page-title text-center" style="font-size:25px;margin-bottom:5px;">TRIAL CASHFLOW</h3>
...
<script>
    ...
    jQuery(document).ready(function(){
        $.post( "<?php echo base_url('finance/statement/ajax_trial_cf/' . $month . '/' . $year);?>", function( data ) {
