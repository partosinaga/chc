			...
			<div id="body">
                <?php
                    ...
                    if($qry_det->num_rows() > 0) {
                        foreach ($qry_det->result() as $row_det) {
                            if (in_array($row_det->coa_id, $bank_account)) {
                                $bank_amount += ($row_det->journal_debit + $row_det->journal_credit);
                            }
                        }
                    }
                ?>
				<table style="width:100%;" class="table_head">
					<tr>
						...
						<td style="width:15%;" class="border_bottom"><?php echo $row->journal_no;?></td>
						<td style="width:22%;">&nbsp;</td>
						<td style="width:15%;"><strong>Reference</strong></td>
                        <td style="width:0.5%;">:</td>
						<td style="width:35%;" class="border_bottom"><?php echo ($row->reference == '') ? '&nbsp;' : $row->reference;?></td>
					</tr>
					<tr>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td class="border_bottom"><?php echo number_format($bank_amount,0,',','.');?></td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td colspan="5" class="border_bottom"><?php echo number_to_words($bank_amount); ?></td>
                    </tr>
					<tr>
