			...
			<div class="col-md-12">
				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>PR Manage
						</div>
						<div class="actions">
							...
							<a href="<?php echo base_url('purchasing/pr/pr_form/1.tpd');?>" class="btn default yellow-stripe">
					...
					<div class="portlet-body">
						<div class="table-container">
                          <form action="<?php echo base_url('purchasing/pr/posting_pr.tpd');?>" method="post" id="frmMain">
							<table class="table table-striped table-bordered table-hover dataTable" id="table_pr_manage">
							<thead>
...
<script>
		...
		var handleRecords = function () {
			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('purchasing/pr/get_pr_manage/' . get_menu_id());?>", // ajax source
					}
				}
			});
			
			var tableWrapper = $("#table_pr_manage_wrapper");
    ...
    $("#table_pr_manage #checkall").click(function () {
        if ($("#table_pr_manage #checkall").is(':checked')) {
            $("#table_pr_manage input[type=checkbox]").each(function () {
