			...
			<div class="col-md-12">
				<div class="portlet box <?php echo BOX;?>">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-user"></i><?php echo ($item_id > 0 ? 'Edit' : 'New');?> Item Service
						</div>
						<div class="actions">
							<a href="<?php echo base_url('purchasing/item/service_manage/1.tpd');?>" class="btn default green-stripe">
					...
					<div class="portlet-body form">
						<form action="<?php echo base_url('purchasing/item/service_submit.tpd');?>" method="post" id="form_sample_icon" class="form-horizontal">
							<input type="hidden" name="item_id" value="<?php echo $item_id;?>" />
							<div class="form-body">
								<?php echo show_flash($this->session->flashdata('flash_message'), $this->session->flashdata('flash_message_item'));?>
								 
								<div class="form-group">
									<label class="control-label col-md-3">Item Service Code <span class="required">
									* </span>
									</label>
									<div class="col-md-4">
								...
								<div class="form-group">
                                    <label class="control-label col-md-3" for="coa_id">Item Service Group<span class="required">
									* </span></label>
                                    <div class="col-md-4">
								...
								<div class="form-group">
									<label class="control-label col-md-3">Item Service Description
									</label>
									<div class="col-md-4">
										<div class="input-icon right">
											<i class="fa"></i>
								...
								<!--div class="form-group">
									...
									<label class="control-label col-md-2">GL Account Code Issue
									</label>
									<div class="col-md-2"> 
								...
								<div class="form-group">
									...
									<div class="col-md-1">
										<div class="input-icon right"> 
											<input type="text" class="form-control" name="qty_distribution" value="<?php echo ($item_id > 0 ? $row->qty_distribution : '');?>"/>
										</div>
									</div> 
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="<?php echo base_url('purchasing/item/service_manage/1.tpd');?>" class="btn red-sunglo">Back</a>
									</div>
								</div>
							</div>
						</form>
