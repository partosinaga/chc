			...
			<div class="col-md-12">
				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>Class List
						</div>
						<div class="actions">
							<?php if(check_session_action(get_menu_id(), STATUS_NEW)){ ?>
							<a href="<?php echo base_url('purchasing/item/class_manage/0.tpd');?>" class="btn default yellow-stripe">
	...
	$(document).ready(function(){
		var handleRecords = function () {
			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('purchasing/item/class_list/' . get_menu_id());?>", // ajax source
					},
		...
		$('.btn-bootbox').live('click', function(){
			...
			bootbox.confirm("Are you sure?", function(result) {
				if(result == true){
					window.location.assign('<?php echo base_url('purchasing/item/class_delete');?>/' + id + '.tpd');
				}
			});
		});
