					...
					<div class="portlet-title">
						<div class="caption">
                            ...
                            <div class="btn-group btn-group-devided">
                                <a href="<?php echo base_url('pos/pos/pos_manage/1.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm <?php echo($is_history ? '' : 'active'); ?>">Manage</a>
                                <a href="<?php echo base_url('pos/pos/pos_manage/2.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm <?php echo($is_history ? 'active' : ''); ?>">History</a>
                            </div>
						...
						<div class="actions">
                            <?php
                                if(!$is_history && check_session_action(get_menu_id(), STATUS_POSTED)){
                                    echo '<a style="margin-left:20px;" href="javascript:;" class="btn-primary btn blue btn-circle hide" id="posting-button"><i class="fa fa-save"></i>&nbsp;Posting</a>&nbsp;';
                                }
                                if(check_session_action(get_menu_id(), STATUS_NEW)) {
                                    //ORDER_STATUS::CHECKIN
                                    echo '<a href="' . base_url('pos/pos/pos_manage/3/0.tpd') . '" class="btn default yellow-stripe">
						...
						<div class="table-container">
                            ...
                            <table class="table table-striped table-bordered table-hover dataTable form-entry table-po-detail" id="table_bill_manage">
                                ...
                                <tr role="row" class="filter bg-grey-steel">
                                    ...
                                    <td><input type="text" class="form-control form-filter input-sm" name="filter_client"></td>
                                    <td><input type="text" class="form-control form-filter input-sm" name="filter_subject"></td>
                                    <!--td></td -->
                                    <td></td>
                                    <td>
		...
		var handleRecords = function () {
			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('pos/pos/get_pos_manage/' . get_menu_id() . '/' . ($is_history ? '1' : '0'));?>" // ajax source
					}
				}
			});
