            ...
            <div class="col-md-12">
                ...
                <div class="portlet box <?php echo BOX ?>" >
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list"></i>Item <?php echo ($itemstock_id > 0 ? 'Edit' : 'New');?>
                        </div>
                        <div class="actions">
                            <a href="<?php echo base_url('pos/setup/stock_list/1.tpd');?>" class="btn default green-stripe">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo base_url('pos/setup/submit_stock.tpd');?>" class="form-horizontal" id="validate-form" method="post" autocomplete="off">
                            <div class="form-body">
                                            ...
                                            <div class="portlet-body portlet-empty">
                                                <div class="form-body" style="margin-left: 15px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Base Unit Cost&nbsp;(IDR)</label>
                                                                <input type="text" placeholder="Unit Cost"  class="form-control text-center mask_currency bold" value="<?php echo ($itemstock_id > 0 ? format_num($row->base_avg_price,0) : '');?>" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
