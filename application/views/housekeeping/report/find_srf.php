                    ...
                    <div class="col-md-7 ">
                        ...
                        <div class="panel ">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group date-picker input-daterange" id="datepicker-range">
                                                <input type="text" class="form-control date_me" name="date_from" id="date_from" value="<?php echo date('d-m-Y', strtotime('-7 days'));?>">
								...
								<div class="form-group" style="vertical-align: middle;">
									<label class="btn control-label col-md-2">Unit</label>
									<div class="col-md-8">
												<select name="unit_id" class="select2me form-control" id="unit_id">
													...
													?>
													<option value="0"  >Public Area</option>
...
<script>
    ...
    $('#btn-submit').click(function(e) {
			...
			var unit_id = $('#unit_id').val();console.log (unit_id);
            var coa_code_list = '';
            ...
            var url = '<?php echo base_url('housekeeping/report/pdf_srf.tpd');?>';
