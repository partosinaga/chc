                            ...
                            <div class="col-md-12" style="padding-bottom: 90px;">
                                <table class="table table-striped table-bordered table-hover dataTable" id="datatable_ajax">
                                    ...
                                    <tr role="row" class="heading">
                                        <th width="1%"> # </th>
                                        <th width="9%">DO Code</th>
                                        <th width="9%">SO Code</th>
                                        <th width="9%">DO Date</th>
                                        <th>Customer</th>
                                    ...
                                    <tr role="row" class="filter bg-grey-steel">
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="filter_do_code">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="filter_so_code">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm date date-picker margin-bottom-5" readonly name="filter_do_date_from" placeholder="From" data-date-format="dd-mm-yyyy">
                                            <input type="text" class="form-control form-filter input-sm date date-picker" readonly name="filter_do_date_to" placeholder="To" data-date-format="dd-mm-yyyy">
                                        </td>
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="filter_delivery_address">
                                        </td>
                                        <td>
        ...
        var handleRecords = function () {
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('sales/delivery_order/do_ajax_list/'.get_menu_id());?>" // ajax source
                    },
