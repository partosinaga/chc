            ...
            <div class="col-md-12">
                ...
                <div class="portlet">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                                <a href="<?php echo base_url('sales/setup/customer_form/0.tpd'); ?>"
                            ...
                            <div class="col-md-12" style="padding-bottom: 90px;">
                                <table class="table table-striped table-bordered table-hover dataTable" id="datatable_ajax">
                                    ...
                                    <tr role="row" class="filter bg-grey-steel">
                                        ...
                                        <td>
                                            <input type="number" class="form-control form-filter input-sm" name="filter_fax">
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
        ...
        var handleRecords = function () {
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('sales/setup/customer_ajax_list');?>" // ajax source
                    },
