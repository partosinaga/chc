<div class="modal-header">
    ...
    <i class="fa fa-cubes font-purple-soft"></i>
    <span class="caption-subject font-purple-soft bold uppercase">Package Inventory</span>
</div>
            ...
            <div class="table-container">
                <div class="portlet-body">
                    ...
                    <div class="tab-content">
                        <table class="table table-striped table-bordered table-hover dataTable"  id="package-datatable">
                            <thead>
                            <tr>
                                <th width="3"> # </th>
                                <th width="12%">Code</th>
                            ...
                            <tr role="row" class="filter bg-grey-steel">
                                ...
                                <td><input type="text" class="form-control form-filter input-sm" name="filter_price"></td>
                                <td>
