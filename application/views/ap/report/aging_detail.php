			...
			<div class="col-md-12" >
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>Report Aging Detail
						</div>
					</div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable table-small table-po-detail" id="datatable_ajax" >
                                    <thead>
                                        <tr class="heading">
                                            ...
                                            <th class="text-center" width="130px"> < 31 DAYS </th>
                                            <th class="text-center" width="130px"> 31 - 60 DAYS </th>
                                            <th class="text-center" width="130px"> 61 - 90 DAYS </th>
                                            <th class="text-center" width="130px"> > 90 DAYS </th>
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: {
					...
					"ajax": {
						"url": "<?php echo base_url('ap/report/ajax_aging_detail/'. get_menu_id());?>"
					},
