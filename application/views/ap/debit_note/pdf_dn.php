...
<div id="container">
    ...
    <div style="margin-top: 10px; display: block;">We Would like to Credit your account with the following details :</div>
    <table style="margin-top: 10px;" class="detail">
        <tr>
            ...
            <th width="150px" class="padding-6" align="right">DN AMOUNT</th>
        </tr>
        <?php
        $i = 0;
