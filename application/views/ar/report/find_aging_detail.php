                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <div class="portlet grey-mint box">
                                            <div class="portlet-title" >
                                                <div class="caption">
                                                    <i class="fa fa-slack"></i>AR Aging Detail
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <button type="button" class="btn green " name="save" id="btn-submit" data-url="<?php echo base_url('ar/report/pdf_aging_detail/'); ?>">Generate AR Aging Detail</button>
