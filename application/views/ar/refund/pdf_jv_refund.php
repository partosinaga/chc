...
<head>
    <meta charset="utf-8">
    <title><?php echo $row->refund_no;?></title>
            ...
            <td width="450px" class="v_top">
                <table class="t_header">
                    <tr>
                        ...
                        <td class="v_top"><?php echo $row->refund_no;?></td>
                    </tr>
                    <tr>
                        <td class="v_top">Date</td>
                        <td class="v_top">:</td>
                        <td class="v_top"><?php echo dmy_from_db($row->refund_date);?></td>
                    </tr>
                </table>
            </td>
            <td>
            ...
            <td colspan="2">
                <table class="t_header" style="padding-top: -2px;">
                    <tr>
                        ...
                        <td width="10px"  class="v_top">:</td>
                        <td class="v_top"><?php echo nl2br($row->remark);?></td>
                    </tr>
                </table>
            </td>
        </tr>
