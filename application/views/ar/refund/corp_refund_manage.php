			...
			<div class="col-md-12">
				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
                            <i></i>&nbsp;Official Receipt Refund
                            <div class="btn-group btn-group-devided">
                                <a href="javascript:;" class="btn btn-transparent grey-gallery btn-circle btn-sm active">Manage</a>
                                <a href="<?php echo base_url('ar/corporate_bill/refund/2.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm ">History</a>
                            </div>
						</div>
						<div class="actions">
                            <a style="margin-left:20px;" href="javascript:;" class="btn-primary btn btn-circle blue" id="posting-button"><i class="fa fa-save"></i>&nbsp;Posting</a>
							<?php if(check_session_action(get_menu_id(), STATUS_NEW)){ ?>
							<a href="<?php echo base_url('ar/corporate_bill/refund/3/0.tpd');?>" class="btn default yellow-stripe">
					...
					<div class="portlet-body table-responsive">
						<div class="table-container">
                          ...
                          <form action="<?php echo base_url('ar/refund/posting_refunds.tpd');?>" method="post" id="frmMain">
							...
							<tr role="row" class="filter bg-grey-steel">
                                ...
                                <td>
                                    <input type="text" class="form-control form-filter input-sm" name="filter_receipt">
                                </td>
                                <td>
...
<script>
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('ar/refund/get_corp_refund_manage/' . get_menu_id());?>"
					}
				}
			});
            ...
            bootbox.prompt({
                ...
                callback: function(result) {
                    if(result === null){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url('ar/refund/action_request');?>",
                            dataType: "json",
                            data: { refund_id: id, action: action, reason:result }
                        })
                            .done(function( msg ) {
                                Metronic.unblockUI();
    ...
    $("#table_refund_manage #checkall").click(function () {
        if ($("#table_refund_manage #checkall").is(':checked')) {
            $("#table_refund_manage input[type=checkbox]").each(function () {
    ...
    $('#posting-button').click(function(e) {
        ...
        var checkedCount = $("#table_refund_manage input[type=checkbox]:checked").length || 0;
