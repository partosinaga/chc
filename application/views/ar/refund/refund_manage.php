					...
					<div class="portlet-title">
						<div class="caption">
                            ...
                            <div class="btn-group btn-group-devided">
                                ...
                                <a href="<?php echo base_url('ar/folio/refund/2.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm ">History</a>
                            </div>
						</div>
						<div class="actions">
							...
							<a href="<?php echo base_url('ar/folio/refund/3/0.tpd');?>" class="btn default yellow-stripe">
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('ar/refund/get_refund_manage/' . get_menu_id());?>"
					}
				}
			});
