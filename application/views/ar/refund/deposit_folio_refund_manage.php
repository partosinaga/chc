				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
                            ...
                            <div class="btn-group btn-group-devided">
                                ...
                                <a href="<?php echo base_url('ar/folio/deposit_refund/2.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm ">History</a>
                            </div>
						</div>
						<div class="actions">
					...
					<div class="portlet-body table-responsive">
						<div class="table-container">
                          ...
                          <form action="<?php echo base_url('ar/refund/posting_deposit_refunds/1.tpd');?>" method="post" id="frmMain">
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('ar/refund/get_deposit_folio_refund_manage/' . get_menu_id());?>"
					}
				}
			});
