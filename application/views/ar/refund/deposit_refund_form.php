	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
                ...
                $form_mode = '';
                $back_url = base_url('ar/corporate_bill/deposit_refund/1.tpd');
                if($refund_id > 0){
                    ...
                    if($row->status == STATUS_CLOSED || $row->status == STATUS_POSTED){
                        $back_url = base_url('ar/corporate_bill/deposit_refund/2.tpd');
                    }
                }
				?>
			</ul>
                ...
                <div class="portlet box <?php echo BOX;?>">
					<div class="portlet-title">
						...
						<div class="actions">
                            ...
                            ?>
                            <a href="<?php echo (isset($row) ? $back_url : base_url('ar/corporate_bill/deposit_refund/1.tpd')); ?>" class="btn default green-stripe">
								...
								<div class="row">
									...
									<div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <span id="company_name" class="control-label text-left bold"><?php echo ($refund_id > 0 ? $row->company_name : '');?></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script>
    ...
    $(document).ready(function(){
        ...
        var handleValidation = function() {
            ...
            form1.validate({
                ...
                messages: {
                    ...
                    reservation_id: "Deposit must be selected",
        ...
        var handleTableModal = function (num_index, depositdetail_id, refund_id) {
            ...
            grid1.init({
                ...
                dataTable: {
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('ar/refund/get_modal_undeposit_by_refund_id');?>/" + num_index + "/" + depositdetail_id + "/" + refund_id // ajax source
                    }
                }
            });
        ...
        $('#btn_lookup_company').on('click', function(){
            ...
            setTimeout(function () {
                $modal.load('<?php echo base_url('ar/refund/xmodal_undeposit');?>.tpd', '', function () {
                    $modal.modal();
        ...
        $('button[name="save"]').click(function(e){
            ...
            if(validate_input()){
                var url = '<?php echo base_url('ar/refund/submit_deposit_refund.tpd');?>';
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if(result === false){
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo base_url('ar/refund/xposting_deposit_refund_by_id');?>",
                                dataType: "json",
