			...
			<div class="col-md-12">
				...
				<div class="portlet">
					<div class="portlet-title">
						...
						<div class="actions">
							<a href="<?php echo base_url('ar/setup/company_manage')?>/0.tpd" class="btn default yellow-stripe">
					...
					<div class="portlet-body">
                        <div class="table-container">
							...
							<tr role="row" class="filter bg-grey-steel">
								...
								<td>
									<input type="text" class="form-control form-filter input-sm" name="filter_company_name">
								</td>
								<td>
									<!-- input type="text" class="form-control form-filter input-sm" name="filter_company_phone" -->
								</td>
                                <td>
                                ...
                                <td>
                                    <input type="text" class="form-control form-filter input-sm" name="filter_company_pic_name">
                                </td>
                                <td>
                                </td>
                                <td>
		...
		var handleRecords = function () {
			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('ar/setup/company_list/'. get_menu_id());?>"
					},
					"order": [
						[1, "asc"]
