					...
					<div class="portlet-title">
						<div class="caption">
                            ...
                            <div class="btn-group btn-group-devided">
                                <a href="<?php echo base_url('ar/corporate_bill/delivery/1.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm">Manage</a>
			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"aoColumns": [
                        ...
                        { "sClass": "text-left" },
                        { "sClass": "text-left", "sWidth" : "15%" , "bSortable": false},
					...
					"ajax": {
						"url": "<?php echo base_url('ar/delivery/get_delivery_history/' . get_menu_id());?>" // ajax source
					}
				}
			});
