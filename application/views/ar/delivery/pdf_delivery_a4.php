...
<head>
    ...
    <link href="<?php echo FCPATH; ?>assets/css/pdf_frontend_invoice_a4.css" rel="stylesheet" type="text/css"/>
...
<table width="100%">
    <tr>
        ...
        <td style="vertical-align:top; text-align:left;padding-top: 20px;"><h1 style="font-size: 18px;"><strong>DELIVERY ORDER</strong></h1></td>
    </tr>
    <tr>
