				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
                            ...
                            <div class="btn-group btn-group-devided">
                                ...
                                <a href="<?php echo base_url('ar/corporate_bill/delivery/2.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm">History</a>
                            </div>
						</div>
						<div class="actions">
                            ...
                            <?php if(check_session_action(get_menu_id(), STATUS_NEW)){ ?>
                                <a href="<?php echo base_url('ar/corporate_bill/delivery/3/0.tpd');?>" class="btn default yellow-stripe">
                                    <i class="fa fa-plus"></i>
							<span class="hidden-480">
							New Delivery Order </span>
                                </a>
                            <?php } ?>
					...
					<div class="portlet-body table-responsive">
						<div class="table-container">
                          ...
                          <form action="javascript:;" method="post" id="frmMain">
		...
		var handleRecords = function () {
			...
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('ar/delivery/get_delivery_manage/' . get_menu_id());?>" // ajax source
					}
				}
			});
            ...
            bootbox.prompt({
                ...
                callback: function(result) {
                    if(result === null){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url('ar/delivery/action_request');?>",
                            dataType: "json",
                            data: { delivery_id: id, action: action, reason:result }
                        })
                            .done(function( msg ) {
                                Metronic.unblockUI();
