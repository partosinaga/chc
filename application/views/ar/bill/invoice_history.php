			...
			<div class="col-md-12">
				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-users"></i>List of Invoices <strong>Closed/Full Paid</strong>
						</div>
						<div class="actions">
                            <div class="btn-group btn-group-devided">
                                <a href="<?php echo base_url('ar/corporate_bill/invoice.tpd');?>" class="btn btn-transparent red-sunglo btn-circle btn-sm">UNPAID</a>
                                <a href="javascript:;" class="btn btn-transparent blue-steel btn-circle btn-sm active">PAID</a>
                            </div>
						</div>
					</div>
...
<script>
	$(document).ready(function(){
        ...
        FormJS.init({
            table_manage_ajax_url : "<?php echo base_url('ar/corporate_bill/get_invoice_history_list/' . get_menu_id());?>"
        });
