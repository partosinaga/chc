					...
					<div class="portlet-title">
						<div class="caption">
                            ...
                            <div class="btn-group btn-group-devided">
                                ...
                                <a href="<?php echo base_url('ar/corporate_bill/receipt_al/2.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm">History</a>
                            </div>
						</div>
						<div class="actions">
...
<script>
	$(document).ready(function(){
        ...
        FormJS.init({
            table_manage_ajax_url : "<?php echo base_url('ar/corporate_bill/get_receipt_al_manage/' . get_menu_id());?>",
            cancel_ajax_url : "<?php echo base_url('ar/corporate_bill/xcancel_receipt_al');?>"
        });
