...
<table width="100%">
    <tr>
        ...
        <td style="vertical-align:top; text-align:left;padding-top: 5px;" ><h1><strong>INVOICE</strong></h1></td>
    </tr>
    <tr>
            ...
            <table style="margin-top: -5px;">
                ...
                <tr>
				 ...
				 <tr>
                    <td>DUE DATE</td>
                    <td>:</td>
                    <td><?php echo(dmy_from_db($row['inv_due_date'])); ?></td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <table style="width:100%;" class="table_detail">
                    ...
                    <tr>
                        ...
                        <th style="" class="text-center">DESCRIPTION</th>
						 <th style="width:30px;padding-right: 8px;" class="text-right">QTY</th>
						 <th style="width:30px;" class="text-center">UNIT</th>
                        <th style="width:50px;padding-right: 10px;" class="text-right">PRICE</th>
                        <th style="width:50px;padding-right: 10px;" class="text-right">TOTAL</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    <tr class="total">
                        ...
                        <td class="border-top text-right" <?php echo ($grandamount < 0 ? 'style="padding-right:6px;"' : 'style="padding-right:3px"') ?>><?php echo (amount_journal($grandamount, 0)) ?></td>
                    </tr>
                    <tr class="total">
                ...
                <table style="margin-top: -2px;">
                    <tr >
                        <td width="350px" style="vertical-align: top;">
                            <table>
                                <tr>
                                    <td style="height: 20px; vertical-align: top; width: 50px;">IN WORDS&nbsp;:</td>
                        ...
                        <td align="center" style="">
                            <table>
                                <tr>
                                    <td class="v_top text-center padding-6" style="height: 90px;vertical-align: top;">
