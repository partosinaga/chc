					...
					<div class="portlet-title">
						<div class="caption">
                            ...
                            <div class="btn-group btn-group-devided">
                                ...
                                <a href="<?php echo base_url('ar/folio/deposit_al/2.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm">History</a>
                            </div>
						</div>
						<div class="actions">
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('ar/deposit/get_folio_al_manage/' . get_menu_id());?>"
					}
				}
			});
