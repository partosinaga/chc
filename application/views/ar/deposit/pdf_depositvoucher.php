...
<head>
	<meta charset="utf-8">
	<title><?php echo $row->deposit_no;?></title>
...
<body>
	...
	<div id="container">
        <div id="header">
            <img src="<?php echo FCPATH;?>assets/img/logo_dwijaya.png" style="height: 80px; position: absolute; top: -75px; left:312px;"/>
			...
			<div id="body">
				<table style="width:100%;" class="table_head">
					<tr>
						...
						<td style="width:15%;" class="border_bottom"><?php echo $row->deposit_no;?></td>
					...
					<tr>
                        ...
                        <td>:</td>
						<td class="border_bottom"><?php echo dmy_from_db($row->deposit_date);?></td>
						<td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td class="border_bottom"><?php echo number_format($row->deposit_paymentamount + $row->deposit_bankcharges,0,',','.');?></td>
                        <td>&nbsp;</td>
                        <td><strong><?php echo isset($subject_title) ? $subject_title : 'Subject'; ?></strong></td>
                        <td>:</td>
                        <td class="border_bottom"><?php echo $row->reservation_id > 0 ? $row->tenant_fullname : $row->company_name ;?></td>
                    </tr>
                    <tr>
                        <td><strong>Say</strong></td>
                        <td>:</td>
                        <td colspan="5" class="border_bottom"><?php echo number_to_words($row->deposit_paymentamount + $row->deposit_bankcharges) ;?></td>
                    </tr>
					<tr>
						<td><strong>Description</strong></td>
                        <td>:</td>
						<td colspan="5" class="border_bottom"><?php echo nl2br($row->deposit_desc, true) ;?></td>
					</tr>
				</table>
				<br/><br/><br/>
                <div >
                ...
                <table style="width:100%" class="table_detail">
                    <tr >
                        ...
                        <td width="15%" class="text-right" style="border-right: 0px; border-left: 0px;border-top: 1px solid #000000;border-bottom: 1px solid #000000;"> <?php echo number_format($journal_amount,0,',','.'); ?></td>
                        ...
                        <td width="15%" class="text-right" style="border-left: 0px;border-top: 1px solid #000000;border-bottom: 1px solid #000000;"> <?php echo number_format($journal_amount,0,',','.'); ?></td>
                    </tr>
                </table>
			</div>
