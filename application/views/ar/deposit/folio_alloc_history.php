			...
			<div class="col-md-12">
				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
                            <i></i>&nbsp;Deposit Folio Allocation
                            <div class="btn-group btn-group-devided">
                                <a href="<?php echo base_url('ar/folio/deposit_al/1.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm">Manage</a>
						...
						<div class="actions">
                            <?php if(check_session_action(get_menu_id(), STATUS_NEW)){ ?>
                                <a href="<?php echo base_url('ar/folio/deposit_al/3/0.tpd');?>" class="btn default yellow-stripe">
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('ar/deposit/get_folio_al_history/' . get_menu_id());?>"
					}
				}
			});
