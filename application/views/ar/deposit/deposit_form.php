                ...
                <div class="portlet box <?php echo BOX;?>">
					<div class="portlet-title">
						...
						<div class="actions">
                            ...
                            ?>
                                <a href="<?php echo base_url('ar/report/pdf_official_receipt/'. ($deposit_id > 0 ? $deposit->deposit_no : '0') .'.tpd');?>" class="btn default blue-ebonyclay" target="_blank"><i class="fa fa-print"></i>&nbsp;Receipt</a>
                            ...
                            ?>
                            <a href="<?php echo (isset($deposit) ? ($deposit->status != STATUS_NEW ? base_url('ar/corporate_bill/deposit/2.tpd') : base_url('ar/corporate_bill/deposit/1.tpd') ) : base_url('ar/corporate_bill/deposit/1.tpd')); ?>" class="btn default green-stripe">
					...
					<div class="portlet-body form">
						<form action="<?php echo base_url('ar/deposit/submit_deposit.tpd');?>" method="post" id="form-entry" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    <input type="hidden" name="company_id" value="<?php echo ($deposit_id > 0 ? $deposit->company_id : '');?>">
                                                    <input type="text" class="form-control" name="company_name" value="<?php echo ($deposit_id > 0 ? $deposit->company_name : '');?>" readonly />
                                                     <span class="input-group-btn">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-inline ">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="deposit_grossamount" name="deposit_grossamount" value="<?php echo ($deposit_id > 0 ? ($deposit->deposit_paymentamount + $deposit->deposit_bankcharges): '0') ;?>" class="form-control text-right mask_currency input-medium" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    $(document).ready(function(){
            ...
            form1.validate({
                ...
                invalidHandler: function (event, validator) { //display error alert on form submit
                    ...
                    if(validator.invalid.company_id != null){
                        toastr["error"](validator.invalid.company_id, "Warning");
                    }
        ...
        var handleTableModal = function (num_index, company_id, deposit_id) {
            ...
            grid1.init({
                ...
                dataTable: {
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('ar/deposit/get_modal_companies');?>/" + num_index + "/" + company_id + "/" + deposit_id // ajax source
                    }
                }
            });
        ...
        $('#btn_lookup_company').on('click', function(){
            ...
            setTimeout(function () {
                $modal.load('<?php echo base_url('ar/deposit/xmodal_company');?>.tpd', '', function () {
                    ...
                    handleTableModal(num_index, company_id, deposit_id);
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        if(result === false){
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo base_url('ar/deposit/xposting_deposit_by_id');?>",
                                dataType: "json",
