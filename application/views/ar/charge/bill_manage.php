					...
					<div class="portlet-title">
						<div class="caption">
                            ...
                            <div class="btn-group btn-group-devided">
                                <a href="<?php echo base_url('ar/corporate_bill/other_charge/1.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm <?php echo($is_history ? '' : 'active'); ?>">Manage</a>
                                <a href="<?php echo base_url('ar/corporate_bill/other_charge/2.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm <?php echo($is_history ? 'active' : ''); ?>">History</a>
                            </div>
						...
						<div class="actions">
                            <?php
                                ...
                                if(check_session_action(get_menu_id(), STATUS_NEW)) {
                                    ...
                                    echo '<a href="' . base_url('ar/corporate_bill/other_charge/3/0.tpd') . '" class="btn default yellow-stripe">
