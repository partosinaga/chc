...
<head>
    <meta charset="utf-8">
    <title><?php echo $row->debit_no;?></title>
...
<div id="container" style="margin-top: 5px;">
            ...
            <td width="450px" class="v_top">
                <table class="t_header">
                    <tr>
                        ...
                        <td class="v_top"><?php echo $row->debit_no;?></td>
                    </tr>
                    <tr>
                        <td class="v_top">Date</td>
                        <td class="v_top">:</td>
                        <td class="v_top"><?php echo dmy_from_db($row->debit_date);?></td>
                    </tr>
                </table>
            </td>
            <td>
            ...
            <td colspan="2">
                <table class="t_header" style="padding-top: -2px;">
                    <tr>
                        ...
                        <td width="10px"  class="v_top">:</td>
                        <td class="v_top"><?php echo nl2br($row->debit_remark);?></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table style="margin-top: 20px;" class="detail">
        <tr><td colspan="5"><p>We would like to Debit your account with the following details :</p></td></tr>
        <tr>
        ...
        foreach($qry_det->result() as $row_det){
            echo '<tr>
                ...
                <td class="padding-4 text-left">' . $row_det->description . '</td>
                <td class="padding-4 text-right">' . format_num($row_det->amount, $dec) . '</td>
                <td class="padding-4 text-right">' . format_num($row_det->tax, $dec) . '</td>
                <td class="padding-4 text-right">' . format_num($row_det->subtotal, $dec) . '</td>
            </tr>';
            $i++;

            $total += $row_det->subtotal;

            //calculate line
            $row_desc = wordwrap_string($row_det->description, 70);
    ...
    <table class="detail" style="margin-top:30px;">
        <tr>
            ...
            <th width="100px" align="right" class="padding-6"><?php echo format_num($total, $dec);?></th>
        </tr>
    </table>
