					...
					<div class="portlet-title">
						<div class="caption">
                            ...
                            <div class="btn-group btn-group-devided">
                                <a href="<?php echo base_url('ar/folio/debit/1.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm">Manage</a>
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('ar/debit/get_debit_history/' . get_menu_id());?>"
					}
				}
			});
