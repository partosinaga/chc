				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption">
                            ...
                            <div class="btn-group btn-group-devided">
                                ...
                                <a href="<?php echo base_url('ar/corporate_bill/debit/2.tpd');?>" class="btn btn-transparent grey-gallery btn-circle btn-sm">History</a>
                            </div>
						</div>
						<div class="actions">
							...
							<a href="<?php echo base_url('ar/corporate_bill/debit/3/0.tpd');?>" class="btn default yellow-stripe">
					...
					<div class="portlet-body table-responsive">
						<div class="table-container">
                          ...
                          <form action="<?php echo base_url('ar/debit/posting_debits.tpd');?>" method="post" id="frmMain">
...
<script>
		...
		var handleRecords = function () {
			grid.init({
				...
				dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
					...
					"ajax": {
						"url": "<?php echo base_url('ar/debit/get_corp_debit_manage/' . get_menu_id());?>"
					}
				}
			});
            ...
            bootbox.prompt({
                ...
                callback: function(result) {
                    if(result === null){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url('ar/debit/action_request');?>",
                            dataType: "json",
                            data: { debitnote_id: id, action: action, reason:result }
                        })
                            .done(function( msg ) {
                                Metronic.unblockUI();
    ...
    $('#posting-button').click(function(e) {
        ...
        $("#frmMain").append('<input type="hidden" name="is_corporate" value="1">');
        $('#frmMain').submit();
    });
    /*
    $('#posting-button').click(function(e) {
